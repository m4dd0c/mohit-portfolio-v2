  ...
  return (
    <section className="w-full font-sans relative overflow-hidden py-10 mt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full mt-32">
        <div className="w-full rounded-2xl border-2 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden relative">
          {/* Grid Background */}
          <div
          ...
          <div className="p-8 relative z-10">
            ...
            <div className="relative inline-flex mb-3 bg-white z-10 ml-1.5 mt-1.5">
              ...
              <div className="border-[1.5px] border-[#0F1A37] px-4 py-1 bg-[#E2F6FF]">
                <span className="text-black font-semibold tracking-wide text-[20px]">
                  Featured Work
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6 mt-2">
              ...
              <div className="flex-[0.6] flex flex-col items-start justify-start">
                ...
                <div className="flex items-center gap-4 flex-wrap z-10">
                  <h2 className="text-[35px] font-bold text-black tracking-tight">
                    Coachify
                  </h2>
                ...
                <p className="text-[#555] text-[18px] font-normal mb-6 max-w-[90%] leading-relaxed z-10 relative">
                  Coachify is a modern EdTech platform designed to help CAT
                  aspirants prepare through live classes, recorded courses, mock
                  tests, practice questions, and free learning resources.
                </p>
                ...
                >
                  View Project
                  <FiArrowUpRight
                    className="text-xl group-hover:rotate-45 transition-transform duration-300"
                    strokeWidth={2.5}
                  />
                </a>
              </div>
                  ...
                  <div className="h-10 border-b-2 border-[#90DDF0] flex items-center px-4 justify-between bg-white">
                    ...
                    <div className="flex-1 flex justify-center">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#00b6e3] text-xs font-semibold">
                          Coachifylive.com
                        </span>
                      </div>
                    </div>
