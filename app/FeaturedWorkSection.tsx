...
export default function FeaturedWorkSection() {
  return (
    <section className="w-full font-sans relative overflow-hidden py-10">
      {/* Background Half Circle */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100vw] h-[100vw] md:h-[60vw] bg-[#F0FAFF] rounded-t-[100%] z-0 pointer-events-none"></div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="flex flex-col lg:flex-row p-8 md:p-14 gap-12 relative z-10">
          ...
          <div className="flex-1 flex flex-col items-start justify-center">
            {/* Tag */}
            <div className="relative inline-flex mb-8 bg-white z-10 ml-1.5 mt-1.5">
            ...
            {/* Description */}
            <p className="text-[#555] text-[18px] font-normal mb-10 max-w-[90%] leading-relaxed z-10 relative">
            ...
            {/* Button */}
            <button className="flex items-center gap-2 bg-black text-white px-8 py-3.5 font-semibold text-lg hover:bg-gray-800 transition-colors z-10 relative rounded-none">
              View Project
          ...
          <div className="flex-1 flex items-center justify-center w-full z-10">
            <div className="w-full aspect-[4/3] bg-white border-[2px] border-black rounded-xl flex items-center justify-center shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden group">
              <img 
                src="/coachify.png" 
