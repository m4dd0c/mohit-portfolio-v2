  ...
  return (
    <footer className="w-full relative overflow-hidden bg-white pt-24 pb-8 font-sans border-t-[1.5px] border-gray-200">
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        {/* Star Left */}
        <svg className="absolute -left-8 md:-left-20 top-0 w-20 h-20 md:w-28 md:h-28 hidden sm:block rotate-[15deg]" viewBox="0 0 100 100">
        ...
        <div className="w-full border-[2px] border-black bg-[#fafafa] shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] p-8 md:p-14 flex flex-col lg:flex-row items-center lg:items-center justify-between gap-10 relative z-20">
          <div className="flex flex-col items-start gap-3">
            <h2 className="text-3xl md:text-5xl font-bold text-black flex items-center flex-wrap gap-4">
              Connect With Me 
        ...
        {/* Star Right */}
        <svg className="absolute -right-8 md:-right-16 -bottom-10 w-24 h-24 md:w-32 md:h-32 hidden sm:block rotate-[25deg] z-0" viewBox="0 0 100 100">
        ...
        {/* Footer Bottom Links */}
        <div className="mt-20 flex flex-col md:flex-row items-center justify-between gap-6 text-sm font-medium z-10 relative">
          <p className="text-black/80 order-2 md:order-1 text-xs sm:text-sm">
            2026 Design By Mohit Jangid
          </p>
          
          <div className="flex items-center gap-2 text-black hover:opacity-80 transition-opacity cursor-pointer order-1 md:order-2">
            <div className="bg-black text-white p-1 rounded-sm flex items-center justify-center">
              <FaLinkedin className="text-sm" />
            </div>
            <span className="font-semibold text-base">Mohitjangid1377@gmail.com</span>
          </div>
        </div>
      </div>
    </footer>
